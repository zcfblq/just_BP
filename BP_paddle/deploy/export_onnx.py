...
def parse_opt():
    ...
    parser.add_argument('--is-pico', default=False,action='store_true' help="是否为PicoDet轻量检测模型")
    parser.add_argument("--trt-nms", default=False,action='store_true' help="是否添加tensorrt nms插件")
